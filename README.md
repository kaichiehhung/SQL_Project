# 研究動機
探索數據領域的就業市場！本專案聚焦於數據分析師職位，探討高薪職缺、熱門技能，以及數據分析領域中高需求與高薪資交匯的關鍵點，旨在精確找出高薪且需求量大的技能，幫助他人更高效地尋找理想職位。

資料來自於Luke的 [SQL課程](https://lukebarousse.com/sql)。 其中包含了職位名稱、薪資、地點及關鍵技能等。
...
- **資料庫技術**： 針對傳統和NoSQL資料庫（如Oracle、NoSQL）的技能需求，平均薪資約為$104,534 和 $101,414，反映了對數據存儲、檢索和管理專業知識的持續需求。
...
1. **高薪數據分析師工作**： 允許遠端工作的數據分析師高薪職位提供了廣泛的薪資範圍，最高可達65萬美元！
